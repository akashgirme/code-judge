    ...
    return (
      ...
      >
            ...
            {selected.map((option) => {
              return (
                ...
                >
                  ...
                  >
                    <Xmark className="h-3 w-3 text-muted-foreground hover:text-foreground" />
                  </button>
                </Badge>
              );
            })}
        ...
        <div className="relative mt-2">
          {open && (
            <CommandList className="absolute top-0 z-20 w-full rounded-md border bg-popover text-popover-foreground shadow-md outline-none animate-in">
              {isLoading ? (
                <>{loadingIndicator}</>
              ) : (
                <>
